...
const SENTENCE_COMP_DATA = [
  ...
  { id:"sc018", chunks:["駅まで", "歩くのに", "十分", "かかります"], correctOrder:[0,1,2,3], starSlot:3, fullSentence:"駅まで　歩くのに　十分　かかります。", translation:"It takes ten minutes to walk to the station.", grammarId:"g072", tag:"quantity" },
  ...
  { id:"sc025", chunks:["このケーキは", "とても", "おいしそうです", "見た目が"], correctOrder:[0,3,1,2], starSlot:4, fullSentence:"このケーキは　見た目が　とても　おいしそうです。", translation:"This cake looks very delicious.", grammarId:"g018", tag:"guessing" },
